...
public class Programs {
    ...
    public String toString() {
        return  name +
                "\nCPU Frequency: " + cpu.getFrequency() + " GHz, Cores: " + cpu.getCores()+
                "\nRAM Memory: " + ram.getMemory() + " GB" +
                "\nDisk Free Space: " + disk.getFree() + " GB, Used Space: " + disk.getUsed() + " GB, Total Space: " + disk.getTotal() + " GB";
    }
